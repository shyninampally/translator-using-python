...
def translate_now():
    ...
    async def do_translate():
        return await t1.translate(text, src=combo1.get(), dest=combo2.get())

    loop = asyncio.get_event_loop()
    trans_text = loop.run_until_complete(do_translate())

    text2.delete(1.0, END)
    text2.insert(END, trans_text.text)

#icon
image_icon=PhotoImage(file="/Users/nampallyshyni/Downloads/google.png")
root.iconphoto(False,image_icon)


#arrow
arrow_image=PhotoImage(file="/Users/nampallyshyni/Downloads/arrow.png")
